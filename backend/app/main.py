...
from app.api import (
    ...
    changelog, careers, career_templates, foreshadows, prompt_workshop, book_import, items
)
...
app.include_router(career_templates.router, prefix="/api")  # 职业模板库API
...
app.include_router(items.router)  # 物品管理API (已包含/api前缀)
